...
class GojekPay
{
    ...
    {
        $this->sessionId = 'A78354AB-9578-4FF5-B899-4BA6BA16483Z'; // generated from self::uuidv4();
        $this->uniqueId  = 'A23194EB-8C6F-45B7-8A80-2606BA847DA1'; // generated from self::uuidv4();
        if ($authToken) {
