...
class Ovo
{
    ...
    */
    ...
    {
        return self::requests(self::AGW_API . "/payment/orders/v1/list?limit=$limit&page=$page", false, $this->headers('Bearer'));
    }
    ...
    */
    ...
    protected function requests($url, $post = false, $headers = false)
    {
        $ch = curl_init();
